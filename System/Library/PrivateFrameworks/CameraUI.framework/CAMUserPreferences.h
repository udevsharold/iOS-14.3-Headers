...
@property (getter=isPALVideoEnabled,nonatomic,readonly) BOOL PALVideoEnabled;                                                                         //@synthesize PALVideoEnabled=_PALVideoEnabled - In the implementation block
...
@property (nonatomic,readonly) BOOL rawControlEnabled;                                                                                                //@synthesize rawControlEnabled=_rawControlEnabled - In the implementation block
@property (nonatomic,readonly) BOOL preserveRAW;                                                                                                      //@synthesize preserveRAW=_preserveRAW - In the implementation block
