...
-(void)appendMetadata:(id)arg1 withTimeStamp:(SCD_Struct_MO6)arg2 toStream:(id)arg3 ;
-(void)finishRecording;
-(id)initWithURL:(id)arg1 andExpectedFrameRate:(double)arg2 ;
-(void)addMetadataTrack:(id)arg1 ;
-(void)appendPixelBuffer:(CVBufferRef)arg1 presentationTime:(SCD_Struct_MO6)arg2 toStreamId:(id)arg3 ;
...
-(void)writingSessionDidStartAtTime:(SCD_Struct_MO6)arg1 streamId:(id)arg2 mediaType:(long long)arg3 writerDelegate:(id)arg4 delegateCallbackQueue:(id)arg5 ;
...
-(id)getMetadataGroupForBuffer:(CVBufferRef)arg1 stream:(id)arg2 presentationTime:(SCD_Struct_MO6)arg3 serializationMode:(int)arg4 ;
-(void)newSampleReady:(opaqueCMSampleBufferRef)arg1 metadata:(id)arg2 presentationTime:(SCD_Struct_MO6)arg3 streamKey:(basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >)arg4 streamId:(id)arg5 isAudioSample:(BOOL)arg6 ;
...
-(BOOL)fifoDropsEnabled:(StreamRecordingData*)arg1 ;
