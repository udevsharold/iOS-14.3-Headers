...
typedef struct ChromaticAdaptation_t {
	...
	/*function pointer*/void* ;
	SCD_Struct_MS70 toneMapMode0;
	SCD_Struct_MS71 toneMapMode1;
	SCD_Struct_MS72) toneMapMode2;
...
typedef struct {
	...
	SCD_Struct_MS81 hcuApiColorConfig;
...
typedef struct {
	SCD_Struct_MS88 output_conversion;
} SCD_Struct_MS89;
...
typedef struct {
	int type;
	/*function pointer*/void* ;
	SCD_Struct_MS91 degmmaC;
	SCD_Struct_MS92) degmmaS;
} SCD_Struct_MS93;
