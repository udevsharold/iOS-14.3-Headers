...
-(void)embeddedSetupToneMappingWithContent:(BOOL)arg1 Output:(IOSurfaceRef)arg2 DMData:(SCD_Struct_HD45*)arg3 tcControl:(ToneCurve_Control*)arg4 hdrControl:(SCD_Struct_HD43*)arg5 hdr10InfoFrame:(SCD_Struct_HD23*)arg6 dmConfig:(SCD_Struct_Do61*)arg7 hdr10OnPad:(BOOL)arg8 useYUVScalingTable:(BOOL)arg9 ;
...
-(void)fillInScalingTable_YUVTM:(SCD_Struct_Do61*)arg1 target_White:(float)arg2 target_Black:(float)arg3 source_White:(float)arg4 source_Black:(float)arg5 satBoost:(float)arg6 scalingFactor:(BOOL)arg7 ;
-(void)createLUTFromDMConfig:(SCD_Struct_Do61*)arg1 TCControl:(ToneCurve_Control*)arg2 HDRControl:(SCD_Struct_HD43*)arg3 ;
...
-(void)setupComposerKernelConfiguration:(SCD_Struct_Do63*)arg1 fromMetaData:(SCD_Struct_HD46*)arg2 ;
...
-(BOOL)dovi_tm_configChanged:(SCD_Struct_Do61*)arg1 HDRControl:(SCD_Struct_HD43*)arg2 EdrAdaptationParam:(EdrAdaptationParam*)arg3 AmbAdaptationParam:(AmbAdaptationParam*)arg4 ;
-(void)dovi_tm_createLUTFromDMConfig:(SCD_Struct_Do61*)arg1 TMParam:(DoViTMParam*)arg2 EdrAdaptationParam:(EdrAdaptationParam*)arg3 AmbAdaptationParam:(AmbAdaptationParam*)arg4 HlgOOTFCombined:(BOOL)arg5 IsDoVi84:(BOOL)arg6 ;
-(void)dovi_tm_updateLUT;
-(void)dovi_tm_reserveConfig:(SCD_Struct_Do61*)arg1 HDRControl:(SCD_Struct_HD43*)arg2 EdrAdaptationParam:(EdrAdaptationParam*)arg3 AmbAdaptationParam:(AmbAdaptationParam*)arg4 ;
-(void)hdr10_createLUTFromDMConfig:(SCD_Struct_Do61*)arg1 HDRControl:(SCD_Struct_HD43*)arg2 TMParam:(HDR10TMParam*)arg3 EdrAdaptationParam:(EdrAdaptationParam*)arg4 AmbAdaptationParam:(AmbAdaptationParam*)arg5 ;
...
-(void)dovi_createLUTFromDMConfig:(SCD_Struct_Do61*)arg1 HDRControl:(SCD_Struct_HD43*)arg2 TMParam:(DoViTMParam*)arg3 EdrAdaptationParam:(EdrAdaptationParam*)arg4 AmbAdaptationParam:(AmbAdaptationParam*)arg5 HlgOOTFCombined:(BOOL)arg6 IsDoVi84:(BOOL)arg7 ;
