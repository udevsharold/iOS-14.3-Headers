...
-(vector<std::__1::shared_ptr<gss::StylesheetQuery<gss::PropertyID> >, std::__1::allocator<std::__1::shared_ptr<gss::StylesheetQuery<gss::PropertyID> > > >*)styleQueries:(const StyleQueryOverride*)arg1 ;
...
-(void)dealloc;
-(BOOL)canAcceptPolygon:(SCD_Struct_VK203*)arg1 ;
