...
@property (nonatomic,copy) NSString * fullAppShortName;                                            //@synthesize fullAppShortName=_fullAppShortName - In the implementation block
...
-(void)setFullAppShortName:(NSString *)arg1 ;
