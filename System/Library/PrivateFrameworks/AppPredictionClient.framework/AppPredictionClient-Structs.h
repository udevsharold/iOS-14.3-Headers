...
typedef struct {
	SCD_Struct_AT11 resultsDidBecomeVisible;
	SCD_Struct_AT11 didStartSearch;
	SCD_Struct_AT11 searchViewDidAppear;
	SCD_Struct_AT11 searchViewDidDisappear;
	SCD_Struct_AT11 didEngageResult;
	SCD_Struct_AT11 didEngageCardSection;
} SCD_Struct_AT12;
