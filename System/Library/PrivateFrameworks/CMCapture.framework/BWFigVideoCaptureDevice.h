...
-(id)unifiedBracketingStillImageCaptureSettingsWithID:(long long)arg1 captureRequestIdentifier:(id)arg2 requestedOutputDimensions:(SCD_Struct_BW2)arg3 frameStatisticsByPortType:(id)arg4 flashMode:(int)arg5 digitalFlashMode:(int)arg6 autoRedEyeReductionEnabled:(BOOL)arg7 hdrMode:(int)arg8 qualityPrioritization:(int)arg9 speedOverQualityCaptureEnabled:(BOOL)arg10 waitForTimeMachineToFill:(BOOL)arg11 burstQualityCaptureEnabled:(BOOL)arg12 deliverOriginalImage:(BOOL)arg13 bravoConstituentImageDeliveryDeviceTypes:(id)arg14 deliverDepthData:(BOOL)arg15 autoDeferredProcessingEnabled:(BOOL)arg16 includePreBracketedEV0ForProcessing:(BOOL)arg17 clientBracketSettings:(id)arg18 userInitiatedRequestPTS:(SCD_Struct_BW8)arg19 rawOutputFormat:(unsigned)arg20 processingSupportProvider:(id)arg21 ;
...
-(id)initWithCaptureDevice:(id)arg1 attributes:(id)arg2 synchronizedStreamsAttributes:(id)arg3 multiCamEnabled:(BOOL)arg4 applicationID:(id)arg5 clientAuditToken:(SCD_Struct_Fi77)arg6 error:(int*)arg7 ;
...
-(int)_createBWFigVideoCaptureStreamsForCaptureStreams:(id)arg1 attributeDictionaries:(id)arg2 cameraParameters:(id)arg3 synchronizedStreamsGroup:(id)arg4 clientAuditToken:(SCD_Struct_Fi77)arg5 ;
