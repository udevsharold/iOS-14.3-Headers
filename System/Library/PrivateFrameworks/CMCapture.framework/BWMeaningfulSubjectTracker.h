...
@interface BWMeaningfulSubjectTracker : NSObject {
	...
	SCD_Struct_BW68 _mostRecentDetectionResult;
	SCD_Struct_BW18 _mostRecentDetectionResultAsTrackingResult;
	SCD_Struct_BW18 _mostRecentTrackingResult;
	SCD_Struct_BW69 _associationParams;
	SCD_Struct_BW71 _mostRecentAssociationResult;
...
-(int)_initializeTrackingOfObject:(SCD_Struct_BW72*)arg1 inPixelBuffer:(CVBufferRef)arg2 usingContext:(id)arg3 examplePixelBuffer:(CVBufferRef)arg4 trackingPixelBuffer:(CVBufferRef)arg5 intermediatePixelBuffer:(CVBufferRef)arg6 estimatedMeanColor:(CVBufferRef)arg7 ;
-(int)_continueTrackingObject:(SCD_Struct_BW72*)arg1 inPixelBuffer:(CVBufferRef)arg2 usingContext:(id)arg3 examplePixelBuffer:(CVBufferRef)arg4 trackingPixelBuffer:(CVBufferRef)arg5 intermediatePixelBuffer:(CVBufferRef)arg6 estimatedMeanColor:(CVBufferRef)arg7 bgraInputPixelBuffer:(SCD_Struct_BW73*)arg8 ;
