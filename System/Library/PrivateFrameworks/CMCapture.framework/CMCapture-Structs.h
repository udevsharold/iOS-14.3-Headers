...
typedef struct AppC3DSession* AppC3DSessionRef;

typedef struct AppC3DTrackingResult* AppC3DTrackingResultRef;
...
typedef struct {
	SCD_Struct_BW64 modelInfo;
	unsigned frameId;
	unsigned numFaces;
	SCD_Struct_BW66 faces[10];
	unsigned numObjects;
	SCD_Struct_BW67 objects[10];
	unsigned numSaliencyObjects;
	SCD_Struct_BW67 saliencyObjects[1];
	SCD_Struct_BW65 saliencyHeatMap;
} SCD_Struct_BW68;
