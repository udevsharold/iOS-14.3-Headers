...
+(void)initialize;
+(id)audioSourceNodeWithAttributes:(id)arg1 sessionPreset:(id)arg2 clock:(OpaqueCMClockRef)arg3 doConfigureAudio:(BOOL)arg4 CMSession:(opaqueCMSessionRef)arg5 doEndInterruption:(BOOL)arg6 clientAuditToken:(SCD_Struct_Fi77)arg7 clientVersionOfLinkedSDK:(unsigned)arg8 audioCaptureConnectionConfigurations:(id)arg9 isMultiCamSession:(BOOL)arg10 ;
...
-(id)_initWithAttributes:(id)arg1 sessionPreset:(id)arg2 clock:(OpaqueCMClockRef)arg3 doConfigureAudio:(BOOL)arg4 CMSession:(opaqueCMSessionRef)arg5 doEndInterruption:(BOOL)arg6 clientAuditToken:(SCD_Struct_Fi77)arg7 clientVersionOfLinkedSDK:(unsigned)arg8 audioCaptureConnectionConfigurations:(id)arg9 isMultiCamSession:(BOOL)arg10 ;
