...
-(void)dealloc;
-(int)_buildMetadataObjectRemoteQueueSinkPipeline:(id)arg1 graph:(id)arg2 metadataNodeOutputs:(id)arg3 videoPreviewEnabled:(BOOL)arg4 deferredPrepareEnabled:(BOOL)arg5 delegate:(id)arg6 clientAuditToken:(SCD_Struct_Fi77)arg7 ;
-(NSString *)sourceID;
-(id)initWithConfiguration:(id)arg1 graph:(id)arg2 name:(id)arg3 videoPreviewOutput:(id)arg4 offlineVISMotionDataSourceOutput:(id)arg5 objectDetectionSourceOutput:(id)arg6 faceTrackingSourceOutput:(id)arg7 captureDevice:(id)arg8 faceTrackingPipelineStage:(id)arg9 clientAuditToken:(SCD_Struct_Fi77)arg10 delegate:(id)arg11 ;
