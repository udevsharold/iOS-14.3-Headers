...
-(id)_initWithClientAuditToken:(SCD_Struct_Fi77)arg1 forThirdPartyTorch:(BOOL)arg2 avconferenceClientApplicationIDs:(id)arg3 applicationAndLayoutStateHandler:(/*^block*/id)arg4 interruptionHandler:(/*^block*/id)arg5 ;
...
-(id)initWithClientAuditToken:(SCD_Struct_Fi77)arg1 forThirdPartyTorch:(BOOL)arg2 applicationAndLayoutStateHandler:(/*^block*/id)arg3 interruptionHandler:(/*^block*/id)arg4 ;
-(id)loggingPrefix;
