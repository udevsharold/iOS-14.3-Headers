...
@property (nonatomic,retain) NSMutableDictionary * mapHashesCache;                                 //@synthesize mapHashesCache=_mapHashesCache - In the implementation block
...
-(void)setMapHashesCache:(NSMutableDictionary *)arg1 ;
