...
@property (assign,nonatomic) BOOL needsContactsReload;                                                                  //@synthesize needsContactsReload=_needsContactsReload - In the implementation block
