...
@class NSArray, NSString, CKConversation, CKEntryViewButton, CKMessageEntryContentView, CKMessageEntryWaveformView, UITraitCollection, UIView, _UIClickInteraction, UILabel, UIVisualEffectView, UIInputContextHistory, CKBrowserSwitcherFooterView, UIButton, UIKBVisualEffectView, CKPaddleOverlayView, CKMentionSuggestionView, NSMutableSet, NSMutableDictionary, CKMentionEntityNode, CAMShutterButton, CKScheduledUpdater, UISwipeGestureRecognizer, CKAudioRecorder, CKComposition, CKActionMenuController, CKInlineAudioReplyButtonController, CKMessageEntryRecordedAudioView, CKMessageEntryAudioHintView, CKActionMenuGestureRecognizerButton;
...
@property (assign,nonatomic) BOOL isAudioActionMenuSuspended;                                                           //@synthesize isAudioActionMenuSuspended=_isAudioActionMenuSuspended - In the implementation block
@property (assign,nonatomic) BOOL isAudioActionMenuResizing;                                                            //@synthesize isAudioActionMenuResizing=_isAudioActionMenuResizing - In the implementation block
...
@property (nonatomic,retain) CKComposition * previousAudioComposition;                                                  //@synthesize previousAudioComposition=_previousAudioComposition - In the implementation block
...
-(void)setPreviousAudioComposition:(CKComposition *)arg1 ;
