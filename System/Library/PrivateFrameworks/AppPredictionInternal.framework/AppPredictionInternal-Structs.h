...
typedef struct {
	unsigned size : 1;
	unsigned timeSinceCreation : 1;
	unsigned timeSinceLastAdded : 1;
	unsigned timeSinceLastOpened : 1;
	unsigned timeSinceModified : 1;
	unsigned isMultipleFileSelection : 1;
} SCD_Struct_Co1;
...
typedef struct {
	unsigned isPhotoWithPeople : 1;
	unsigned isPhotoWithText : 1;
	unsigned isRotationCandidate : 1;
	unsigned isScreenshot : 1;
	unsigned isTrimCandidate : 1;
} SCD_Struct_Co3;
...
typedef struct {
	...
	unsigned numEngagementsInAppPredictionPanelTodayPage : 1;
	...
	unsigned numEngagementsInSuggestionsWidgetTodayPage : 1;
	unsigned sessionLengthInSeconds : 1;
	unsigned appLibraryEnabled : 1;
	unsigned appLibraryViewed : 1;
	unsigned appPredictionPanelEnabled : 1;
	unsigned appPredictionPanelTodayPageEnabled : 1;
	unsigned appPredictionPanelTodayPageViewed : 1;
	unsigned appPredictionPanelViewed : 1;
	unsigned spotlightActionsViewed : 1;
	unsigned spotlightAppsViewed : 1;
	unsigned spotlightEnabled : 1;
	unsigned suggestionsWidgetEnabled : 1;
	unsigned suggestionsWidgetTodayPageEnabled : 1;
	unsigned suggestionsWidgetTodayPageViewed : 1;
	unsigned suggestionsWidgetViewed : 1;
} SCD_Struct_AT9;
...
typedef struct {
	...
	unsigned actionTotalExplicitRejectsNoDecay : 1;
	...
	unsigned appDirectoryConfirmsAtCoarseGeohashForApp : 1;
	unsigned appDirectoryConfirmsAtCoarseGeohashForAppInContext : 1;
	unsigned appDirectoryConfirmsAtCoarseGeohashInContext : 1;
	unsigned appDirectoryConfirmsAtCoarseTimePOWLocationForApp : 1;
	unsigned appDirectoryConfirmsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned appDirectoryConfirmsAtCoarseTimePOWLocationInContext : 1;
	unsigned appDirectoryConfirmsAtSpecificGeohashForApp : 1;
	unsigned appDirectoryConfirmsAtSpecificGeohashForAppInContext : 1;
	unsigned appDirectoryConfirmsAtSpecificGeohashInContext : 1;
	unsigned appDirectoryConfirmsAtSpecificTimeDOWLocationForApp : 1;
	unsigned appDirectoryConfirmsAtSpecificTimeDOWLocationForAppInContext : 1;
	unsigned appDirectoryConfirmsAtSpecificTimeDOWLocationInContext : 1;
	unsigned appDirectoryConfirmsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned appDirectoryConfirmsForAllAppsAndContextsDecayedAtSpecificContextRate : 1;
	unsigned appDirectoryConfirmsInTwoHourTimeIntervalForApp : 1;
	unsigned appDirectoryConfirmsInTwoHourTimeIntervalForAppInContext : 1;
	unsigned appDirectoryConfirmsInTwoHourTimeIntervalInContext : 1;
	unsigned appDirectoryConfirmsOnDayOfWeekForApp : 1;
	unsigned appDirectoryConfirmsOnDayOfWeekForAppInContext : 1;
	unsigned appDirectoryConfirmsOnDayOfWeekInContext : 1;
	unsigned appDirectoryExplicitRejectsAtCoarseTimePOWLocationForApp : 1;
	unsigned appDirectoryExplicitRejectsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned appDirectoryExplicitRejectsAtCoarseTimePOWLocationInContext : 1;
	unsigned appDirectoryExplicitRejectsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned appDirectoryRejectsAtCoarseGeohashForApp : 1;
	unsigned appDirectoryRejectsAtCoarseGeohashForAppInContext : 1;
	unsigned appDirectoryRejectsAtCoarseGeohashInContext : 1;
	unsigned appDirectoryRejectsAtCoarseTimePOWLocationForApp : 1;
	unsigned appDirectoryRejectsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned appDirectoryRejectsAtCoarseTimePOWLocationInContext : 1;
	unsigned appDirectoryRejectsAtSpecificGeohashForApp : 1;
	unsigned appDirectoryRejectsAtSpecificGeohashForAppInContext : 1;
	unsigned appDirectoryRejectsAtSpecificGeohashInContext : 1;
	unsigned appDirectoryRejectsAtSpecificTimeDOWLocationForApp : 1;
	unsigned appDirectoryRejectsAtSpecificTimeDOWLocationForAppInContext : 1;
	unsigned appDirectoryRejectsAtSpecificTimeDOWLocationInContext : 1;
	unsigned appDirectoryRejectsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned appDirectoryRejectsForAllAppsAndContextsDecayedAtSpecificContextRate : 1;
	unsigned appDirectoryRejectsInTwoHourTimeIntervalForApp : 1;
	unsigned appDirectoryRejectsInTwoHourTimeIntervalForAppInContext : 1;
	unsigned appDirectoryRejectsInTwoHourTimeIntervalInContext : 1;
	unsigned appDirectoryRejectsOnDayOfWeekForApp : 1;
	unsigned appDirectoryRejectsOnDayOfWeekForAppInContext : 1;
	unsigned appDirectoryRejectsOnDayOfWeekInContext : 1;
	unsigned appDirectoryTotalLaunchesForAllApps : 1;
	unsigned appDirectoryTotalLaunchesForApp : 1;
	...
	unsigned appExplicitRejectsCoarseTimePowLocationForAllAppsAndContexts : 1;
	unsigned appExplicitRejectsCoarseTimePowLocationForApp : 1;
	unsigned appExplicitRejectsCoarseTimePowLocationForAppInContext : 1;
	unsigned appExplicitRejectsCoarseTimePowLocationInContext : 1;
	...
	unsigned homeScreenActionConfirmsAtCoarseGeohashForAction : 1;
	unsigned homeScreenActionConfirmsAtCoarseGeohashForActionInContext : 1;
	unsigned homeScreenActionConfirmsAtCoarseGeohashInContext : 1;
	unsigned homeScreenActionConfirmsAtCoarseTimePOWLocationForAction : 1;
	unsigned homeScreenActionConfirmsAtCoarseTimePOWLocationForActionInContext : 1;
	unsigned homeScreenActionConfirmsAtCoarseTimePOWLocationInContext : 1;
	unsigned homeScreenActionConfirmsAtSpecificGeohashForAction : 1;
	unsigned homeScreenActionConfirmsAtSpecificGeohashForActionInContext : 1;
	unsigned homeScreenActionConfirmsAtSpecificGeohashInContext : 1;
	unsigned homeScreenActionConfirmsAtSpecificTimeDOWLocationForAction : 1;
	unsigned homeScreenActionConfirmsAtSpecificTimeDOWLocationForActionInContext : 1;
	unsigned homeScreenActionConfirmsAtSpecificTimeDOWLocationInContext : 1;
	unsigned homeScreenActionConfirmsAtTimeOfDayForAction : 1;
	unsigned homeScreenActionConfirmsAtTimeOfDayForActionInContext : 1;
	unsigned homeScreenActionConfirmsAtTimeOfDayInContext : 1;
	unsigned homeScreenActionConfirmsOnDayOfWeekForAction : 1;
	unsigned homeScreenActionConfirmsOnDayOfWeekForActionInContext : 1;
	unsigned homeScreenActionConfirmsOnDayOfWeekInContext : 1;
	unsigned homeScreenActionRejectsAtCoarseGeohashForAction : 1;
	unsigned homeScreenActionRejectsAtCoarseGeohashForActionInContext : 1;
	unsigned homeScreenActionRejectsAtCoarseGeohashInContext : 1;
	unsigned homeScreenActionRejectsAtCoarseTimePOWLocationForAction : 1;
	unsigned homeScreenActionRejectsAtCoarseTimePOWLocationForActionInContext : 1;
	unsigned homeScreenActionRejectsAtCoarseTimePOWLocationInContext : 1;
	unsigned homeScreenActionRejectsAtSpecificGeohashForAction : 1;
	unsigned homeScreenActionRejectsAtSpecificGeohashForActionInContext : 1;
	unsigned homeScreenActionRejectsAtSpecificGeohashInContext : 1;
	unsigned homeScreenActionRejectsAtSpecificTimeDOWLocationForAction : 1;
	unsigned homeScreenActionRejectsAtSpecificTimeDOWLocationForActionInContext : 1;
	unsigned homeScreenActionRejectsAtSpecificTimeDOWLocationInContext : 1;
	unsigned homeScreenActionRejectsAtTimeOfDayForAction : 1;
	unsigned homeScreenActionRejectsAtTimeOfDayForActionInContext : 1;
	unsigned homeScreenActionRejectsAtTimeOfDayInContext : 1;
	unsigned homeScreenActionRejectsOnDayOfWeekForAction : 1;
	unsigned homeScreenActionRejectsOnDayOfWeekForActionInContext : 1;
	unsigned homeScreenActionRejectsOnDayOfWeekInContext : 1;
	unsigned homeScreenAppConfirmsAtCoarseGeohashForApp : 1;
	unsigned homeScreenAppConfirmsAtCoarseGeohashForAppInContext : 1;
	unsigned homeScreenAppConfirmsAtCoarseGeohashInContext : 1;
	unsigned homeScreenAppConfirmsAtCoarseTimePOWLocationForApp : 1;
	unsigned homeScreenAppConfirmsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned homeScreenAppConfirmsAtCoarseTimePOWLocationInContext : 1;
	unsigned homeScreenAppConfirmsAtSpecificGeohashForApp : 1;
	unsigned homeScreenAppConfirmsAtSpecificGeohashForAppInContext : 1;
	unsigned homeScreenAppConfirmsAtSpecificGeohashInContext : 1;
	unsigned homeScreenAppConfirmsAtSpecificTimeDOWLocationForApp : 1;
	unsigned homeScreenAppConfirmsAtSpecificTimeDOWLocationForAppInContext : 1;
	unsigned homeScreenAppConfirmsAtSpecificTimeDOWLocationInContext : 1;
	unsigned homeScreenAppConfirmsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned homeScreenAppConfirmsForAllAppsAndContextsDecayedAtSpecificContextRate : 1;
	unsigned homeScreenAppConfirmsInTwoHourTimeIntervalForApp : 1;
	unsigned homeScreenAppConfirmsInTwoHourTimeIntervalForAppInContext : 1;
	unsigned homeScreenAppConfirmsInTwoHourTimeIntervalInContext : 1;
	unsigned homeScreenAppConfirmsOnDayOfWeekForApp : 1;
	unsigned homeScreenAppConfirmsOnDayOfWeekForAppInContext : 1;
	unsigned homeScreenAppConfirmsOnDayOfWeekInContext : 1;
	unsigned homeScreenAppExplicitRejectsAtCoarseTimePOWLocationForApp : 1;
	unsigned homeScreenAppExplicitRejectsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned homeScreenAppExplicitRejectsAtCoarseTimePOWLocationInContext : 1;
	unsigned homeScreenAppExplicitRejectsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned homeScreenAppRejectsAtCoarseGeohashForApp : 1;
	unsigned homeScreenAppRejectsAtCoarseGeohashForAppInContext : 1;
	unsigned homeScreenAppRejectsAtCoarseGeohashInContext : 1;
	unsigned homeScreenAppRejectsAtCoarseTimePOWLocationForApp : 1;
	unsigned homeScreenAppRejectsAtCoarseTimePOWLocationForAppInContext : 1;
	unsigned homeScreenAppRejectsAtCoarseTimePOWLocationInContext : 1;
	unsigned homeScreenAppRejectsAtSpecificGeohashForApp : 1;
	unsigned homeScreenAppRejectsAtSpecificGeohashForAppInContext : 1;
	unsigned homeScreenAppRejectsAtSpecificGeohashInContext : 1;
	unsigned homeScreenAppRejectsAtSpecificTimeDOWLocationForApp : 1;
	unsigned homeScreenAppRejectsAtSpecificTimeDOWLocationForAppInContext : 1;
	unsigned homeScreenAppRejectsAtSpecificTimeDOWLocationInContext : 1;
	unsigned homeScreenAppRejectsForAllAppsAndContextsDecayedAtCoarseContextRate : 1;
	unsigned homeScreenAppRejectsForAllAppsAndContextsDecayedAtSpecificContextRate : 1;
	unsigned homeScreenAppRejectsInTwoHourTimeIntervalForApp : 1;
	unsigned homeScreenAppRejectsInTwoHourTimeIntervalForAppInContext : 1;
	unsigned homeScreenAppRejectsInTwoHourTimeIntervalInContext : 1;
	unsigned homeScreenAppRejectsOnDayOfWeekForApp : 1;
	unsigned homeScreenAppRejectsOnDayOfWeekForAppInContext : 1;
	unsigned homeScreenAppRejectsOnDayOfWeekInContext : 1;
	unsigned homeScreenTotalLaunchesForAllApps : 1;
	unsigned homeScreenTotalLaunchesForApp : 1;
	unsigned installAge : 1;
	unsigned intentCategory : 1;
	unsigned intentCategoryFromIntentDefinition : 1;
	unsigned isAppClip : 1;
	...
	unsigned slotFeedbackMinutesSinceLastExplicitRejectInHomeScreen : 1;
	...
	unsigned slotFeedbackTotalExplicitRejectsForAllSlotsNoDecay : 1;
	unsigned slotFeedbackTotalExplicitRejectsForSlotNoDecay : 1;
