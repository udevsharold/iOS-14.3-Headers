...
@class HKQuantity, NSNumber, NSArray, NSDictionary, NSSet, NSString;
...
@property (nonatomic,retain) NSArray * startedCycleFactors;                               //@synthesize startedCycleFactors=_startedCycleFactors - In the implementation block
@property (nonatomic,retain) NSArray * endedCycleFactors;                                 //@synthesize endedCycleFactors=_endedCycleFactors - In the implementation block
...
-(void)setStartedCycleFactors:(NSArray *)arg1 ;
-(NSArray *)endedCycleFactors;
-(void)setEndedCycleFactors:(NSArray *)arg1 ;
