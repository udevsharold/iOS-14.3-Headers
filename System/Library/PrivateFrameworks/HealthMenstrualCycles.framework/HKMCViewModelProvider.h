...
@class HKMCViewModelProviderDataSource, HKMCAnalysisProvider, NSHashTable, NSObject, NSMutableIndexSet, NSMutableDictionary, NSArray, NSNumber, HKMCAnalysis, HKCalendarCache, NSString;
