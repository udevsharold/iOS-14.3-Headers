...
@class WFActionUserInterfaceListener, WFWorkflowRunningContext, WFDialogAttribution, NSProgress, UIView, MTMaterialView, WFCompactStatusViewController, NSTimer, WFDialogRequest, WFCompactUnlockService, WFDebouncer, NSString;
...
@property (assign,nonatomic) BOOL preparingToPresentDialog;                                          //@synthesize preparingToPresentDialog=_preparingToPresentDialog - In the implementation block
...
@property (nonatomic,retain) WFDebouncer * singleStepShortcutCompletionDialogDebouncer;              //@synthesize singleStepShortcutCompletionDialogDebouncer=_singleStepShortcutCompletionDialogDebouncer - In the implementation block
...
-(void)dismissPersistentChromeWithSuccess:(BOOL)arg1 customAttribution:(id)arg2 completionHandler:(/*^block*/id)arg3 ;
...
-(void)setSingleStepShortcutCompletionDialogDebouncer:(WFDebouncer *)arg1 ;
@end
