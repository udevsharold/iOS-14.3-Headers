...
@class AXPhoenixClassifierConfiguration, MLModel, AccelerometerBuffer, PredictionsBuffer, MLMultiArray, NSArray, NSObject, NSString, AXPhoenixDataLogger;
...
@property (assign,nonatomic) BOOL falsePositiveLoggingEnabled;              //@synthesize falsePositiveLoggingEnabled=_falsePositiveLoggingEnabled - In the implementation block
-(void)reset;
-(void)dealloc;
-(id)configuration;
-(id)version;
...
-(void)_logWindowData:(id)arg1 doubleTap:(BOOL)arg2 tapData:(SCD_Struct_AX0)arg3 ;
