...
@property (assign,nonatomic) double vo2MaxValueStdDev;                                                       //@synthesize vo2MaxValueStdDev=_vo2MaxValueStdDev - In the implementation block
@property (assign,nonatomic) double vo2MaxValueMaxConsecutiveDifference;                                     //@synthesize vo2MaxValueMaxConsecutiveDifference=_vo2MaxValueMaxConsecutiveDifference - In the implementation block
@property (assign,nonatomic) double vo2MaxValueMaxTotalDifference;                                           //@synthesize vo2MaxValueMaxTotalDifference=_vo2MaxValueMaxTotalDifference - In the implementation block
@property (assign,nonatomic) double vo2MaxSampleTimeNoiseStdDev;                                             //@synthesize vo2MaxSampleTimeNoiseStdDev=_vo2MaxSampleTimeNoiseStdDev - In the implementation block
