...
-(double)switchValue;
-(CGRect)_knobFrameForMetrics:(SCD_Struct_HU11)arg1 switchValue:(double)arg2 ;
-(HUDynamicFormattingLabel *)supplementaryValueLabel;
-(CGSize)_knobSizeForMetrics:(SCD_Struct_HU11)arg1 ;
-(CGPoint)_knobCenterForMetrics:(SCD_Struct_HU11)arg1 switchValue:(double)arg2 ;
