...
@class HFItem, HMHome, HUQuickControlContainerView, UILayoutGuide, UITapGestureRecognizer, UIPanGestureRecognizer, HUAnimationApplier, HUQuickControlViewControllerCoordinator, HUQuickControlViewController, HUQuickControlPresentationContext, NSString;
