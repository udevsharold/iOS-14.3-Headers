...
@class HUAppleMusicAccountModuleController, HUPrimaryUserSettingsItemModuleController, NAFuture, NADeallocationSentinel, UIAlertController, NSString;
...
@property (nonatomic,retain) HUPrimaryUserSettingsItemModuleController * primaryUserModuleController;                   //@synthesize primaryUserModuleController=_primaryUserModuleController - In the implementation block
...
-(void)setPrimaryUserModuleController:(HUPrimaryUserSettingsItemModuleController *)arg1 ;
