...
@class NSDictionary, UILabel, UIVisualEffectView, HUWaveformView, HURecordingButton, UIScrollView, UIStackView, NSString, HFAudioRecorder, NSURL, UIBlurEffect, UIView, HUAnnouncementGlobeView, UIButton, UILongPressGestureRecognizer, NSLayoutConstraint, UIImpactFeedbackGenerator, ANAnnounce, HMHome;
