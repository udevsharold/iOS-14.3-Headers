...
@property (nonatomic,retain) HUVisualEffectContainerView * firmwareUpdateView;                   //@synthesize firmwareUpdateView=_firmwareUpdateView - In the implementation block
...
-(void)setFirmwareUpdateView:(HUVisualEffectContainerView *)arg1 ;
