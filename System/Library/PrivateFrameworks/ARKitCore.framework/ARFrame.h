...
@property (nonatomic,copy) NSArray * detectedPersonMetadata;                                       //@synthesize detectedPersonMetadata=_detectedPersonMetadata - In the implementation block
...
-(void)setDetectedPersonMetadata:(NSArray *)arg1 ;
