...
@property (assign,getter=isPersonMetadataEnabled,nonatomic) BOOL personMetadataEnabled;                //@synthesize personMetadataEnabled=_personMetadataEnabled - In the implementation block
