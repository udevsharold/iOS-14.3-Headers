...
@class WFWorkflow, WFDatabase, WFAction, WFWorkflowController, WFContentCollection, WFDialogTransformer, WFRunWorkflowFooterView, NSIndexPath, WFWorkflowRunEvent, WFWorkflowViewController, WFRunWorkflowToolbar, NSString;
