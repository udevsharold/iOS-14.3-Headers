...
@class NSHashTable, UINotificationFeedbackGenerator, SBHomeGestureInteraction, SBSystemGestureManager, SBKeyboardHomeAffordanceAssertion, SBHomeGrabberView, NSString;
...
@property (nonatomic,retain) SBKeyboardHomeAffordanceAssertion * keyboardHomeAffordanceAssertion;              //@synthesize keyboardHomeAffordanceAssertion=_keyboardHomeAffordanceAssertion - In the implementation block
...
-(void)setKeyboardHomeAffordanceAssertion:(SBKeyboardHomeAffordanceAssertion *)arg1 ;
