...
@property (nonatomic,readonly) SBVoiceCommandButton * voiceCommandButton;                                                  //@synthesize voiceCommandButton=_voiceCommandButton - In the implementation block
...
-(SBVoiceCommandButton *)voiceCommandButton;
