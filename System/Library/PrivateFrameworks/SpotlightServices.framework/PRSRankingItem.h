...
@property (assign,nonatomic) BOOL displayNameInitialsFirstWordAndMoreMatchOnly;              //@synthesize displayNameInitialsFirstWordAndMoreMatchOnly=_displayNameInitialsFirstWordAndMoreMatchOnly - In the implementation block
...
@property (assign,nonatomic) BOOL wordMatchedKeyword;                                        //@synthesize wordMatchedKeyword=_wordMatchedKeyword - In the implementation block
