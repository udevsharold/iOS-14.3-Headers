...
@property (assign,nonatomic) BOOL measurementStartupAutoscale;                                                //@synthesize measurementStartupAutoscale=_measurementStartupAutoscale - In the implementation block
@property (nonatomic,retain) id externalSelectionModelCoordinate;                                             //@synthesize externalSelectionModelCoordinate=_externalSelectionModelCoordinate - In the implementation block
@property (assign,nonatomic) BOOL externalSelectionScheduled;                                                 //@synthesize externalSelectionScheduled=_externalSelectionScheduled - In the implementation block
@property (assign,nonatomic) double externalSelectionLastLocation;                                            //@synthesize externalSelectionLastLocation=_externalSelectionLastLocation - In the implementation block
...
-(void)_touchAtPoint:(CGPoint)arg1 ;
