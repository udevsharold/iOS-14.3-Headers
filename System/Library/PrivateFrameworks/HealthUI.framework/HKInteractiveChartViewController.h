...
@property (assign,nonatomic) BOOL disableCurrentValueViewForInitialLollipop;                                                        //@synthesize disableCurrentValueViewForInitialLollipop=_disableCurrentValueViewForInitialLollipop - In the implementation block
