...
+(double)calculateCCTForChromaticity:(SCD_Struct_CB34)arg1 ;
+(double)calculateCCTForTristimulus:(SCD_Struct_CB35)arg1 ;
+(SCD_Struct_CB35)calculateTristimulusForChromaticity:(SCD_Struct_CB34)arg1 andLux:(double)arg2 ;
