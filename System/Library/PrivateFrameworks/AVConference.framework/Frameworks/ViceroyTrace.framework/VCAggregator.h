...
@class NSString, NSNumber, NSObject, VCAlgosStreamingScorer;
...
@property (readonly) VCAlgosStreamingScorer * algosScorer;              //@synthesize algosScorer=_algosScorer - In the implementation block
...
-(VCAlgosStreamingScorer *)algosScorer;
@end
