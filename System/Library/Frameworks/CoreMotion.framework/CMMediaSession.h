...
-(void)_feedPoseAnchor:(const Sample*)arg1 facePoseError:(SCD_Struct_CM437*)arg2 ;
-(unsigned)totalFacePoseAnchorSamples;
-(void)setTotalFacePoseAnchorSamples:(unsigned)arg1 ;
-(void)feedPoseAnchorWithAttitude:(SCD_Struct_CM397)arg1 position:(CMVector<float, 3>)arg2 timestampUs:(unsigned long long)arg3 ;
...
-(void)_feedFacePose:(id)arg1 rotationMatrix:(id)arg2 timestamp:(double)arg3 error:(SCD_Struct_CM437*)arg4 ;
