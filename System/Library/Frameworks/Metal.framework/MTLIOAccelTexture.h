...
-(BOOL)isCompressed;
-(void)replaceRegion:(SCD_Struct_MT49)arg1 mipmapLevel:(unsigned long long)arg2 withBytes:(const void*)arg3 bytesPerRow:(unsigned long long)arg4 ;
...
-(void)getBytes:(void*)arg1 bytesPerRow:(unsigned long long)arg2 fromRegion:(SCD_Struct_MT49)arg3 mipmapLevel:(unsigned long long)arg4 ;
