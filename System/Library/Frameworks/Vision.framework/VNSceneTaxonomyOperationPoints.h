...
@interface VNSceneTaxonomyOperationPoints : VNOperationPoints {
	...
	SCD_Struct_VN61* _operationPointsDataArray;
...
-(id)initWithLabelToOperationPointsDataIndexMap:(id)arg1 operationPointsDataArray:(SCD_Struct_VN61*)arg2 ;
-(const SCD_Struct_VN61*)_operationPointsDataForClassificationIdentifier:(id)arg1 error:(id*)arg2 ;
