...
@interface VNTrajectoryProcessor : NSObject {
	...
	SCD_Struct_VN51 _lastAnalyzedFramePTS;
	SCD_Struct_VN51 _nextFrameToBeAnalyzedPTS;
...
-(void)dealloc;
-(id)initWithFrameAnalysisSpacing:(SCD_Struct_VN51)arg1 trajectoryLength:(long long)arg2 ;
