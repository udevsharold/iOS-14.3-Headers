...
@interface ShotflowNetwork : NSObject {
	...
	SCD_Struct_VN57* _espressoNetwork;
	void* _espressoPlan;
...
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_VN57*)arg1 espressoPlan:(void*)arg2 threshold:(float)arg3 ;
-(int)setInputShape:(unsigned long long)arg1 height:(unsigned long long)arg2 ;
-(float)threshold;
-(void)dealloc;
-(void)setThreshold:(float)arg1 ;
-(void)initializeBuffers;
-(id)initWithEspressoNetwork:(SCD_Struct_VN57*)arg1 espressoPlan:(void*)arg2 threshold:(float)arg3 ;
