...
@interface _CLLSLHeading : NSObject <NSCopying, NSSecureCoding> {
	...
	SCD_Struct_CL33 _rotationFromGlobalToDeviceFrame;
	SCD_Struct_CL33 _rotationFromGlobalToCameraFrame;

}

@property (assign,nonatomic) double timestamp;                                             //@synthesize timestamp=_timestamp - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL33 rotationFromGlobalToDeviceFrame;              //@synthesize rotationFromGlobalToDeviceFrame=_rotationFromGlobalToDeviceFrame - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL33 rotationFromGlobalToCameraFrame;              //@synthesize rotationFromGlobalToCameraFrame=_rotationFromGlobalToCameraFrame - In the implementation block
...
-(id)description;
-(SCD_Struct_CL33)rotationFromGlobalToDeviceFrame;
-(SCD_Struct_CL33)rotationFromGlobalToCameraFrame;
-(_CLLSLHeadingSupplInfo *)supplemantaryInfo;
-()rotationalAccuracyInRadians;
-(unsigned long long)globalReferenceFrame;
-(void)setRotationFromGlobalToDeviceFrame:(SCD_Struct_CL33)arg1 ;
-(void)setRotationFromGlobalToCameraFrame:(SCD_Struct_CL33)arg1 ;
