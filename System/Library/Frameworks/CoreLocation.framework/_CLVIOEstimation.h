...
@interface _CLVIOEstimation : NSObject <NSCopying, NSSecureCoding> {
	...
	SCD_Struct_CL35 _inertialStateInfo;
	SCD_Struct_CL35 _inertialCovarianceInfo;
	SCD_Struct_CL33 _cameraIntrinsics;
	SCD_Struct_CL15 _cameraPose;
...
@property (assign,nonatomic) SCD_Struct_CL35 inertialStateInfo;                   //@synthesize inertialStateInfo=_inertialStateInfo - In the implementation block
@property (nonatomic,copy) NSData * inertialState;                                //@synthesize inertialState=_inertialState - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL35 inertialCovarianceInfo;              //@synthesize inertialCovarianceInfo=_inertialCovarianceInfo - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_CL15 cameraPose;                          //@synthesize cameraPose=_cameraPose - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL33 cameraIntrinsics;                    //@synthesize cameraIntrinsics=_cameraIntrinsics - In the implementation block
...
-(SCD_Struct_CL35)inertialStateInfo;
-(NSData *)inertialState;
-(SCD_Struct_CL35)inertialCovarianceInfo;
-(NSData *)inertialCovariance;
-(SCD_Struct_CL15)cameraPose;
-(SCD_Struct_CL33)cameraIntrinsics;
-(CGSize)cameraImageResolution;
-(void)setTrackingState:(int)arg1 ;
-(void)setOriginTimestamp:(double)arg1 ;
-(void)setInertialStateInfo:(SCD_Struct_CL35)arg1 ;
-(void)setInertialState:(NSData *)arg1 ;
-(void)setInertialCovarianceInfo:(SCD_Struct_CL35)arg1 ;
-(void)setInertialCovariance:(NSData *)arg1 ;
-(void)setCameraPose:(SCD_Struct_CL15)arg1 ;
-(void)setCameraIntrinsics:(SCD_Struct_CL33)arg1 ;
