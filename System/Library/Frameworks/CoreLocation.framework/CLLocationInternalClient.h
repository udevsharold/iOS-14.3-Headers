...
-(unsigned char)configure:(SCD_Struct_CL18)arg1 ;
...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL20*)arg5 ;
...
-(void)setMapMatchingRouteHint:(SCD_Struct_CL23*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
...
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL25*)arg1 magneticField:(SCD_Struct_CL24)arg2 acceleration:(SCD_Struct_CL24)arg3 ;
...
-(unsigned char)getGyroCalibrationDatabaseBiasFit:(SCD_Struct_CL28*)arg1 atTemperature:(float)arg2 ;
-(const CFArrayRef)copyActivityAlarms;
-(unsigned char)getStatusBarIconEnabled:(BOOL*)arg1 forEntityClass:(unsigned)arg2 ;
-(unsigned char)compassCalibrationDatabaseSetBias:(SCD_Struct_CL24)arg1 magneticField:(SCD_Struct_CL24)arg2 level:(int)arg3 magnitude:(float)arg4 inclination:(float)arg5 ;
...
-(unsigned char)insertGyroCalibrationDatabaseBiasEstimateIfValid:(SCD_Struct_CL24)arg1 temperature:(float)arg2 variance:(SCD_Struct_CL24)arg3 timestamp:(double)arg4 ;
-(id)connection;
