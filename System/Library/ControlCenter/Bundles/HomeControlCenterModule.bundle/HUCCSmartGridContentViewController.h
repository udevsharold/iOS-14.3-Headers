...
@interface HUCCSmartGridContentViewController : UIViewController <HUCCGridViewControllerDelegate, HUCCSmartGridViewControllerDelegate, HUCCDashboardContainerViewControllerDelegate, HUCCSmartGridPropertyAnimatorDelegate, CCUIContentModuleContentViewController> {
	...
	BOOL _isExpanded;
	BOOL _isTransitioningToHomeControlService;
...
@property (assign,nonatomic) BOOL isTransitioningToHomeControlService;                                             //@synthesize isTransitioningToHomeControlService=_isTransitioningToHomeControlService - In the implementation block
...
-(void)setIsTransitioningToHomeControlService:(BOOL)arg1 ;
