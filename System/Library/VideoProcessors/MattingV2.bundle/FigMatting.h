...
@class NSDictionary, FigMetalContext, Texture2DWrapper, NSMutableDictionary, NSMutableArray, ConstraintsGenerator, FocalPlaneV2, MPSImageSpatioTemporalGuidedFilter, MattingV2TuningParameters, NSArray, NSString;
