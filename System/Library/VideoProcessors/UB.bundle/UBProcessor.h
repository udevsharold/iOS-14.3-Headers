...
@class NSDictionary, FigWiredMemory, DenoiseFusePipeline, UBPlist, RegWarpHelper, FigM2MController, RegWarpPP, FigMetalContext, LSCGainsPlist, NSMutableDictionary, UBConfig, UBFusionOutput, UBDeepFusionOutput, UBOutput, UBProgressiveBracketingParameters, NSString;

@interface UBProcessor : NSObject <SidecarWriter, ImageBufferProcessor> {

	SCD_Struct_UB59 _memoryRequirements;
	...
	SCD_Struct_UB67 _registrationPipelineRWPPConfig;
	...
	SCD_Struct_De32 _evmGreenTintAdjustmentParams;
	BOOL _doRedFaceFix;
...
-(UBOutput *)output;
-(int)allocateResources:(const SCD_Struct_UB59*)arg1 ;
-(void)dealloc;
...
-(int)determineWorkingBufferRequirementsWithOptions:(id)arg1 memoryAllocationInfo:(SCD_Struct_UB59*)arg2 ;
...
-(void)StartKTraceEventForAddFrame:(frameProperties_t*)arg1 timestamp:(SCD_Struct_UB68)arg2 ;
-(id)getProcessingTypeKey:(frameProperties_t*)arg1 ;
-(void)EndKTraceEventForAddFrame:(frameProperties_t*)arg1 timestamp:(SCD_Struct_UB68)arg2 ;
...
-(int)_processSIFRandRefEV0IfPossible:(int)arg1 ;
-(void)setProgressiveBatchSize:(int)arg1 ;
-(BOOL)_shouldPrewarmDeepFusion:(id)arg1 ;
-(int)getOptions:(id)arg1 ;
-(void)applyOverrides;
-(int)determineWorkingBufferRequirementsWithOptions:(id)arg1 ubConfig:(id)arg2 memoryAllocationInfo:(SCD_Struct_UB59*)arg3 ;
...
-(CGRect)_downscaleRoiForRegistration:(CGRect)arg1 ;
