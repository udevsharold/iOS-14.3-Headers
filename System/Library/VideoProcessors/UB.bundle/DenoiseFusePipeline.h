...
@interface DenoiseFusePipeline : NSObject {
	...
	SCD_Struct_De30 _ambnrStageCache;
...
+(int)calculateBackingBufferLayoutForDesc:(id)arg1 ubConfig:(id)arg2 metal:(id)arg3 layout:(SCD_Struct_De31*)arg4 ;
...
-(int)denoiseFrame:(id)arg1 outputChroma:(id)arg2 inputLuma:(id)arg3 inputChroma:(id)arg4 scratchLuma:(id)arg5 scratchChroma:(id)arg6 localGainMap:(id)arg7 skinMask:(id)arg8 maskExtent:(CGRect)arg9 exposure:(const exposureParameters*)arg10 staticScene:(BOOL)arg11 ubPlist:(id)arg12 isLowLight:(BOOL)arg13 ;
...
-(int)doSyntheticReference:(id)arg1 noiseDivisorOutputTex:(id)arg2 lscGainsTex:(id)arg3 config:(const FusionConfiguration*)arg4 evmProperties:(const frameProperties_t*)arg5 evmGreenTintAdjustment:(SCD_Struct_De32)arg6 ev0Properties:(const frameProperties_t*)arg7 ubPlist:(id)arg8 intermediateMetadata:(id)arg9 ;
-(int)computeRansacColorMatchingCoefficients:(const FusionConfiguration*)arg1 scaleEv0brightness:(float)arg2 applyToPyramid:(BOOL)arg3 andStoreTransform:(SCD_Struct_De32*)arg4 ;
