...
-(int)generateNoiseMap:(id)arg1 outputNoiseMapChroma:(id)arg2 noiseDivisorTex:(id)arg3 lscGainsTex:(id)arg4 evm:(id)arg5 ev0:(id)arg6 evmHomography:(SCD_Struct_Wa0)arg7 ev0Homography:(SCD_Struct_Wa0)arg8 evmProperties:(const frameProperties_t*)arg9 evmGreenTintAdjustmentParams:(SCD_Struct_De32)arg10 ev0Properties:(const frameProperties_t*)arg11 ;
