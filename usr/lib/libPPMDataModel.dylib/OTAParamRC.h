...
@interface OTAParamRC : PBCodable <NSCopying> {
	...
	SCD_Struct_OT1* _coeffSOCs;
	SCD_Struct_OT1* _coeffVs;
	SCD_Struct_OT1* _gridOCVs;
	SCD_Struct_OT1* _gridWRdcRatios;
...
@property (assign,nonatomic) BOOL hasWRdcRatioThresh; 
@property (assign,nonatomic) float wRdcRatioThresh;                                                        //@synthesize wRdcRatioThresh=_wRdcRatioThresh - In the implementation block
@property (nonatomic,readonly) unsigned long long gridWRdcRatiosCount; 
@property (nonatomic,readonly) float* gridWRdcRatios; 
@property (nonatomic,readonly) unsigned long long coeffSOCsCount; 
@property (nonatomic,readonly) float* coeffSOCs; 
@property (nonatomic,readonly) unsigned long long coeffVsCount; 
@property (nonatomic,readonly) float* coeffVs; 
...
-(unsigned long long)gridWRdcRatiosCount;
-(void)clearGridWRdcRatios;
-(float)gridWRdcRatioAtIndex:(unsigned long long)arg1 ;
-(void)addGridWRdcRatio:(float)arg1 ;
-(unsigned long long)coeffSOCsCount;
-(void)clearCoeffSOCs;
-(float)coeffSOCAtIndex:(unsigned long long)arg1 ;
-(void)addCoeffSOC:(float)arg1 ;
-(unsigned long long)coeffVsCount;
-(void)clearCoeffVs;
-(float)coeffVAtIndex:(unsigned long long)arg1 ;
-(void)addCoeffV:(float)arg1 ;
-(BOOL)hasBaselineR1;
-(BOOL)hasBaselineR2;
-(BOOL)hasRCFreq1;
-(BOOL)hasRCFreq2;
...
-(void)setWRdcRatioThresh:(float)arg1 ;
-(void)setHasWRdcRatioThresh:(BOOL)arg1 ;
-(BOOL)hasWRdcRatioThresh;
-(float*)gridWRdcRatios;
-(void)setGridWRdcRatios:(float*)arg1 count:(unsigned long long)arg2 ;
-(float*)coeffSOCs;
-(void)setCoeffSOCs:(float*)arg1 count:(unsigned long long)arg2 ;
-(float*)coeffVs;
-(void)setCoeffVs:(float*)arg1 count:(unsigned long long)arg2 ;
