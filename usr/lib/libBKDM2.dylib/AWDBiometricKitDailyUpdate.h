...
@interface AWDBiometricKitDailyUpdate : PBCodable <NSCopying> {
	...
	SCD_Struct_AW22* _baseTemplateFeatureCounts;
	SCD_Struct_AW22* _bioCheckInfos;
	SCD_Struct_AW22* _bioCheckResults;
	SCD_Struct_AW22* _matchingBinCounts;
	SCD_Struct_AW22* _matchingIdentityCounts;
	SCD_Struct_AW22* _matchingTemplateTypeCounts;
	SCD_Struct_AW22* _onlineUpdateTemplateFeatureCounts;
	SCD_Struct_AW22* _passcodeUpdateTemplateFeatureCounts;
	SCD_Struct_AW22* _passcodeUpdates;
